...
- **Linux**: Debian 10 Buster … 13 Trixie / Raspbian Buster+ / Ubuntu 22.04+ (кросс-платформа)
- **Архитектура**: x86_64 или ARM (тестировалось на обоих — MSI Cubi x86 и Raspberry Pi)
- **Python**: 3.7+ (код кросс-совместим: Raspbian Buster Py3.7 → Debian 13 Py3.13)
